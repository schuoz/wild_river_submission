...
CODE_PATH="${HOME}/df/work/wild_river/wild_river_xception"

cd ${CODE_PATH}
source gchm/bash/config.sh

# set wandb api key
source ${HOME}/df/work/wild_river/wild_river_xception/.config_wandb 
...
batch_size=18
nb_epoch=1000  
iterations_per_epoch=300  # if None: one epoch corresponds to the full dataset len(dl_train)
...
nohup python gchm/train_val.py --out_dir=${out_dir} \
                          ...
                          --base_model_dir=${base_model_dir} > training_model_51.log &
