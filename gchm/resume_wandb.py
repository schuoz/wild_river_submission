import wandb
import torch
#run = wandb.init(entity="shzong-ETH Zürich", project="gchm", id="ufa184a4", resume="must")
import logging
...
if os.path.exists(checkpoint_path):
    ...
    print(f"Resuming training from epoch {trainer.start_epoch}")
